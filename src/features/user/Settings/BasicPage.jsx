    ...
    return (
      <Segment>
        ...
        <Form>
          ...
          <Field width={8} name="dateOfBirth" component={DateInput} placeholder="Date of Birth" 
                dateFormat="YYYY-MM-DD" showYearDropdown={true} showMonthDropdown={true} 
                dropdownMode="select" 
                maxDate={moment().subtract(18, 'years')} /> 
          <Field name="city" placeholder="Home Town" options={{ types: ["(cities)"] }} label="Female" 
                component={PlaceInput} width={8} />
